  ...
  return (
    <>
      <section className='max-w-[1440px] w-full mx-auto mt-4 px-[20px] xl:px-0'>
          ...
          <div className="flex flex-wrap gap-5 lg:gap-10 justify-center py-5 lg:py-10">
            ...
            <Loding/>
              ...
              productData.map(item => (
                <NavLink to={`/catelogues/catelogues-details/${item.slug}`} className="bg-c6/60 rounded-2xl max-w-[285px]  w-[46.2%] lg:w-full  bg:blur-sm hover:bg-c6 transition delay-75 ease-in-out  ">
                  ...
                  <div className={` w-full ease-out duration-200 mx-auto p-1.5`}>
                    <img src={item.images[0]} alt="" loading='lazy' className=' w-full max-h-[346px] rounded-xl bg-slate-400 hover:scale-[.97] transition delay-75 ease-in-out' />
                  </div>
                  {/* detel */}
        ...
        {/* section 4 */}
        <section className='flex gap-5 lg:gap-14 my-14 flex-wrap-reverse justify-center'>
          <div className="max-w-[553px] *:rounded-2xl">
          ...
          <div className=" pt-5 flex flex-col bottom-0 ">
            ...
            <div className="flex gap-5 lg:gap-14 *:max-w-[350px]  *:rounded-2xl mt-[50px]">
              <div className="">
              ...
              <div className="">
                <div className="relative">
                  ...
                  <img src="https://cdn.prod.website-files.com/6607bf6b9d59d5c6248298a2/6607dc963f551ea6b785022f_kid.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
