  ...
  return (
    <>
      <section className=" w-full flex flex-col">
        <div className="flex gap-4 text-3xl mx-auto  mt-10">
          <Package size={35} />
          <p className="font-semibold">My Orders</p>
        </div>

        <section className="border-2 p-5 m-8  rounded-2xl *:w-full flex  justify-start flex-wrap *:m-2 *:border *:rounded-2xl *:max-w-[600px]">
